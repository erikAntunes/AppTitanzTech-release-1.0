...
class FragmentServicos : Fragment(), ServicosListener {

    private var recyclerViewServicos: RecyclerView? = null
    private var servicosAdapter: ServicosAdapter? = null

    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {

        val view = inflater.inflate(R.layout.servicos_fragment, container, false)

        val servicosArrayList = ArrayList<Servicos>()

        val servico1 = Servicos()
        servico1.nome = "Desenvolvimento  Android Mobile"
        servico1.imagem = "https://lh3.googleusercontent.com/juJbKDXGoATNAavlLhVNmiWCGh4PdqXBzR30Uz1XqXtPyq46QwoXwEuQojLmMTnVryTrYJWQnB15nWoCbsfadaJVaJKbouwf9m_IoFGPpxo7iFmDWawhTXGYza5urJkuihp6GPlI8g9qjb6311AlzX-xy4YHWkWMSn9Rvc15n7sB2qSdfWhgcQ6JXYQII1x_GSvi9ngWBYM_G0aQlvvJzRkDmKT6pQ9UfwX7JtydZ8MiU7SeDcPAIxOyqUFOMjKmI75smbVRU_aH0XOCKh9Y_l3OJoWmtZb5xIUW1tqLKu5Vpech8RV3RRGpfWBPEIthjxMGWGuLZFiZu9pdzY27xQO1AqEYyvqqkHmMvyQVEyvoQlNHv1LgUWBk0Lfw0CvmIzh3gbpVUIh5-d6N8NtEoMwfGV1a6eM8wPi6sFC6qjnlQhmzFOaisY5gQ-DkXj-Bq7xSKs0NyBqgfuMJmFTuzjgJuzRHjimRDTcK6_XvSiTItgE2TwlBt78apB1UWAjbeYd1xvDiSbf7lhZo-KbukycSYt1Zl365d4kaEF7Y_3E33ydyyuh0DlMTIRsk38Pnddp0JOO_BFt9c9--dshPAlQpUuxHnpMs10dVJVnh6mDqDfB7p0kumeO0YpieY9EDqGYxRY9iP9Lzku-RAwuoQqDrTQTUViRI0YbLinqPFWRCzTT3mBWBAZR9d8JXJ2RgrSRwHTKHEUJdiFeDuE8kHal4e--bwPirl6WprRwHmCw-lbmx=s800-no"
        servico1.descricao = "A Titanz Tech, oferece um serviço único na Região Sul de São Paulo. Com desenvolvimento de Aplicativos Android Mobile, focados em Comercios, Vendas Digitais e Delivery, cobrando um preço justo e acessível para os empreendedores da Era Digital."
        servico1.id = "01"
        servicosArrayList.add(servico1)
        val servico2 = Servicos()
        servico2.nome = "Formatação de Notebooks"
        ...
        servicosAdapter = ServicosAdapter(servicosArrayList, this)

        recyclerViewServicos!!.adapter = servicosAdapter
        recyclerViewServicos!!.layoutManager = layoutManager
        return view
    }

    override fun onServicoClicado(servico: Servicos) {

        val intent = Intent(context, DetalhesServicosActivity::class.java)
