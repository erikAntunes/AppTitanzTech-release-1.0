...
public class FragmentPromocoes extends Fragment implements PromocoesListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        promocoes2.setDescricao("Breve descrição");
        ...
        promocoes3.setDescricao("Breve descrição");
        ...
        promocoes4.setDescricao("Breve Descrição");
        ...
        promocoes5.setDescricao("Breve Descrição");
        ...
        promocoes6.setDescricao("Breve Descrição");
        ...
        promocoes8.setDescricao("Breve Descrição");
        ...
        promocoes9.setDescricao("Breve Descrição");
